...
void overly_DNN_FullRunII_only_3bins()
{


      TFile *f1 = TFile::Open("datacards_161718_syst_1SigCla_3bins/datacards/limit_scan.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP1 =(TGraph*)f1->Get("T1ttttExpectedLimit");
      TGraph *Gr_Exp_NTOP2 =(TGraph*)f1->Get("T1ttttExpectedLimitUp");
      TGraph *Gr_Exp_NTOP3 =(TGraph*)f1->Get("T1ttttExpectedLimitDown");
//      TH2D *grid = (TH2D*)f1->Get("T1ttttObservedExcludedXsec");
...
//      grid->Draw("CLOZ");
      ...
      leg->AddEntry(Gr_Exp_NTOP1, "Expected limit", "l");
      leg->AddEntry(Gr_Exp_NTOP2, "Expected #pm 1 #sigma ", "l");
      ...
      c11->SaveAs("Limit_FullRunII_only_nonparam_3bins.png");

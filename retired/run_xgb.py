...
if __name__ == '__main__':
    ...
    if args.multib : 
        ...
        # variables to be used in the training 
        var_list = ['MET', 'MT', 'Jet2_pt','Jet1_pt', 'nLep', 'Lep_pt', 'Selected', 'nVeto', 'LT', 'HT', 'nBCleaned_TOTAL','nTop_Total_Combined', 'nJets30Clean', 'dPhi',"Lep_relIso","Lep_miniIso","iso_pt","iso_MT2","W_fromHadTop_dRb","W_fromHadTop_dRb_2","W_fromHadTop_dRb_3","W_fromHadTop_dRb_4","nWLoose","nWMedium","nWTight","nWVeryTight","mGo", "mLSP"]
        # variables to be used in while transfere DFs
    ...
    # init the modele 
    scoreing = score('XGB',args.outdir,splitted.test_DF,splitted.train_DF,splitted.class_weights,var_list=var_list,do_multiClass = MultiClass,nSignal_Cla = int(args.nSignal_Cla),do_parametric = args.do_parametric,class_names=class_names)

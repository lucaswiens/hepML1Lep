...
void overly_DNN_Multi()
{
      ...
      TFile *f3 = TFile::Open("BaseLine_Limit_Pantelis/limit_scan_130.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      ...
      leg->AddEntry(Gr_Exp_NTOP3, "baseline limit calculated at 130 fb^{-1}", "l");
      leg->AddEntry(Gr_Exp_NTOP1, "expected limit DNN based with 1 bin from 0.997", "l");
      leg->AddEntry(Gr_Exp_NTOP2, "expected limit DNN based with 6 bin from 0.9 ", "l");
      ...
      c11->SaveAs("Limit_FullRunII_only_param_multibins.png");

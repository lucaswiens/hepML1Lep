...
void overly_DNN_Multi2Cla()
{
      ...
      TFile *f3 = TFile::Open("Xmas_Limits_HDM/datacards/limit_scan.root"); //testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP3 =(TGraph*)f3->Get("T1ttttExpectedLimit");

      TFile *f4 = TFile::Open("Xmas_Limits_LDM/datacards/limit_scan.root"); //testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP4 =(TGraph*)f4->Get("T1ttttExpectedLimit");

      Gr_Exp_NTOP2->SetLineColor(6);
      Gr_Exp_NTOP3->SetLineColor(4);
      Gr_Exp_NTOP4->SetLineColor(1);
      ...
      TLegend *leg = new TLegend(0.25,0.25,0.65,0.4);
      leg->SetFillStyle(0);
      leg->SetBorderSize(0);
      ...
      leg->AddEntry(Gr_Exp_NTOP3, "DNN  HDM 35.9 fb^{-1} 1-bin", "l");
      leg->AddEntry(Gr_Exp_NTOP4, "DNN  LDM 35.9 fb^{-1} 1-bin", "l");
      ...
      c11->SaveAs("overly_DNN_Multi2Cla.png");

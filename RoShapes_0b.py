...
from plotClass.SRs.search_regions_0b import All_files

import plotClass.SRs.search_regions_0b as sr
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exec', help="wight directory",default='./batch/shape_exec_0b.sh' ,metavar='exec')

...
if __name__ == '__main__':
    ...
    for bkg_list in bkg_dires : 
        ...
        a = np.array([[TTl_2,TTll_2,WJ_2],[TTl_3,TTll_3,WJ_3],[TTl_4,TTll_4,WJ_4]])
        
        b = np.array([Data_2,Data_3,Data_4])
        n = len(b)
        ...
        txtalphabetagamma.write("{:<20}{:<12}{:<10}{:<12}{:<10}{:<12}{:<10}{:<12}{:<10}".format('DiLepTTCat'    ,TTl_3       ,'+/-'+str(round(err_4,2)) ,TTll_3    ,'+/-'+str(round(err_10,2)),WJ_3     ,'+/-'+str(round(err_13,2)) ,Data_3 ,'+/-'+str(round(err_6,2 )))+"\n")

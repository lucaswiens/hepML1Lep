...
TTxsec = {
    'DiLepTT' :
        {
        'scale_up' : '1.3*1000.0/sumOfWeights*genWeight*Xsec*1*btagSF*puRatio*lepSF*nISRttweight',
        'scale_dn' : '0.7*1000.0/sumOfWeights*genWeight*Xsec*1*btagSF*puRatio*lepSF*nISRttweight',
        },

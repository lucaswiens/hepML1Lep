...
for i,m in enumerate(selected_var) : 
    SRs_cut_strings[massList[i]]   = cut_strings+"&&(("+m[0]+">"+m[1]+" ) && ("+m[0]+">"+m[2]+") && ("+m[0]+" >"+m[3]+") && (nJets30Clean > 6))"# &&("+m[0]+" >= 0.9))" #+ dPhiCut + ntopCut #&& ("+m[0]+" > 0.8)"
    CRs_1_cut_strings[massList[i]] = cut_strings+"&&(("+m[0]+">"+m[1]+" ) && ("+m[0]+">"+m[2]+") && ("+m[0]+" >"+m[3]+") && (nJets30Clean <= 6))" #+ AntidPhiCut #&& ("+m[0]+" <= 0.8)"

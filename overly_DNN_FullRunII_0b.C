...
void overly_DNN_FullRunII_0b()
{


      TFile *f1 = TFile::Open("datacards_161718_syst_0b_1bin/datacards/limit_scan.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP1 =(TGraph*)f1->Get("T1ttttExpectedLimit");
      TFile *f2 = TFile::Open("datacards_161718_syst_0b_6bins/datacards/limit_scan.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP2 =(TGraph*)f2->Get("T1ttttExpectedLimit");

      TFile *f3 = TFile::Open("datacards_161718_syst_1SigCla_0b_1bin/datacards/limit_scan.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      TGraph *Gr_Exp_NTOP3 =(TGraph*)f3->Get("T1ttttExpectedLimit");

      TFile *f4 = TFile::Open("datacards_161718_syst_1SigCla_0b_6bins/datacards/limit_scan.root");//testLimits_alpha_nT/datacards/limit_scan.root");
      ...
      leg->SetFillStyle(0);
      leg->SetBorderSize(0);
      leg->SetHeader("T5qqqqWW NLO+NLL exclusion");
      leg->AddEntry(Gr_Exp_NTOP1, "expected limit param. 1 bin optimized for each mass", "l");
      leg->AddEntry(Gr_Exp_NTOP2, "expected limit param. 6 bin from 0.9", "l");
      leg->AddEntry(Gr_Exp_NTOP3, "expected limit non-param 1 bin from 0.995 ", "l");
      ...
      c11->SaveAs("Limit_param_vs_nonparam_0b.png");
